# ref_seq_win_dict creates a dictionary to hold reference sequence with a user 
# given window size from a reference fasta 
...
def main():
    """
    Makes a dictionary to iterate through a reference and save to file with pickle.

    USAGE:
        python ref_seq_win_dict.py <table> <s> <dicfile>

    ARGS:
        fil1, name and location of table file with scaffold names and sizes
